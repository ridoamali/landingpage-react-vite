          ...
          <Row className="header-box d-flex align-items-center pt-lg-5 overflow-hidden">
            <Col lg="6">
              <h1 className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Temukan <br /> <span>Bakat Anda</span> <br /> Bersama Kami
              </h1>
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo asperiores corporis maiores hic explicabo labore.</p>
